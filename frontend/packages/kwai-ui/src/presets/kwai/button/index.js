export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      // Primary Button
      {
        'text-primary-contrast text-primary-text': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
      ...
      // Primary Text Button
      { 'text-primary-text': props.text && props.severity === null && !props.plain },

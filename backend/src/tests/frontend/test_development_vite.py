...
def vite() -> Vite:
    ...
    vite = DevelopmentVite(Path("/home/kwai/website"))
...
def test_development_vite_scripts(vite: Vite):
    ...
    assert scripts[0] == '<script src="/home/kwai/website/@vite/client"></script>'
    assert scripts[1] == '<script src="/home/kwai/website/src/index.ts"></script>'
